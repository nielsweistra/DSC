Configuration InstallIISRoles
{
 ...
 Import-DscResource -Module xWebAdministration
  ...
  Node $AllNodes.Where{$_.Role -contains "WebServerMinimal"}.Nodename
   {
   ...
   Node $AllNodes.Where{$_.Role -contains "WebServerFull"}.Nodename
   {
...
InstallIISRoles -ConfigurationData 005-installIIS.psd1